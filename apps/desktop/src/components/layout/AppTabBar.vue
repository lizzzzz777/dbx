...
import { Activity, AlertTriangle, CalendarClock, ChevronDown, Code2, Copy, Database, Gauge, GitBranch, KeyRound, Lock, Maximize2, Minimize2, Network, Package, Pencil, PencilRuler, PictureInPicture2, Pin, Search, Settings, ShieldCheck, Table2, TableProperties, X } from "@lucide/vue";
