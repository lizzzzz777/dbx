...
export default withEnglishFallback({
  ...
  grid: {
    ...
    formatterForeignKeyHint: "Carrega rótulos para as chaves da página atual. Edição, filtro, ordenação, cópia e exportação continuam usando os valores originais.",
  ...
  structureEditor: {
    ...
    copyColumnsSelectSourceTable: "Selecione uma tabela de origem",
