...
export default withEnglishFallback({
  ...
  grid: {
    ...
    formatterForeignKeyHint: "仅加载当前页外键对应的显示值；编辑、筛选、排序、复制和导出仍使用原始值。",
  ...
  panelDetach: {
    dock: "合并回主窗口",
    detach: "分离为独立窗口",
    tableInfoEmpty: "在对象浏览器中选择要查看的表",
    objectBrowserMissingConnection: "未找到此对象浏览器窗口对应的连接。",
    multiExecuteUnsupported: "分离窗口暂不支持多库执行",
  },
  common: {
  ...
  nacos: {
    ...
    accessIncompleteRoleHint: "这是一个历史异常角色，缺少成员或命名空间权限。保存修改前必须补齐两项配置。",
