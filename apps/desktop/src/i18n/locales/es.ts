...
export default withEnglishFallback({
  ...
  connection: {
    ...
    promptPasswordMessage: "Introduzca la contraseña de la conexión “{connection}”. No se guardará localmente.",
  ...
  settings: {
    ...
    sidebarOpenDatabaseOnSingleClick: "Abrir objetos de base de datos con un clic",
    sidebarOpenDatabaseOnSingleClickDescription: "Si está activado, al hacer un solo clic en un nodo de base de datos o esquema se expande el árbol lateral y se abre su pestaña de objetos (equivalente a doble clic).",
