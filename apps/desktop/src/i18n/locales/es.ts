...
export default withEnglishFallback({
  ...
  grid: {
    ...
    formatterForeignKeyHint: "Carga etiquetas para las claves de la página actual. La edición, el filtrado, la ordenación, la copia y la exportación usan los valores originales.",
